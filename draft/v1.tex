...
All code used to create the dataset from original sources, is available through a Github repository made public upon publication. Also included in the repository are code and data used to validate the dataset as well as generate the figure. \footnote{\url{https://github.com/libgober/database_of_laws}}. Versions of these files used at time of submission to \textit{Scientific Data} are available in the OSF repository. 
